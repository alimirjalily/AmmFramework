using System.Data;
using AmmFramework.Extensions.Translations.Parrot.DataModel;
using AmmFramework.Extensions.Translations.Parrot.Options;
using Dapper;
using Microsoft.Data.SqlClient;
using Microsoft.Extensions.Logging;

namespace AmmFramework.Extensions.Translations.Parrot.Databases;
...
public class ParrotSqlRepository
{
        ...
        ILogger logger)
    {
        ...
        _ = new Timer(LoadLocalizationRecords,
            null,
            TimeSpan.FromMinutes(configuration.ReloadDataIntervalInMinutes),
            TimeSpan.FromMinutes(configuration.ReloadDataIntervalInMinutes));
