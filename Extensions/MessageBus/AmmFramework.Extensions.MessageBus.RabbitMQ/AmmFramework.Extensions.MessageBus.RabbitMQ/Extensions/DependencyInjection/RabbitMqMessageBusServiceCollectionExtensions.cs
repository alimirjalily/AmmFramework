...
using AmmFramework.Extensions.MessageBus.RabbitMQ.Options;
...
namespace AmmFramework.Extensions.MessageBus.RabbitMQ.Extensions.DependencyInjection
{
    ...
    {
        public static IServiceCollection AddFrameworkRabbitMqMessageBus(this IServiceCollection services, IConfiguration configuration, List<Type>? commands = null, Dictionary<string, List<Type>>? events = null)
        {
        ...
        public static IServiceCollection AddFrameworkRabbitMqMessageBus(this IServiceCollection services, IConfiguration configuration, string sectionName, List<Type>? commands = null, Dictionary<string, List<Type>>? events = null)
        {
            services.AddFrameworkRabbitMqMessageBus(configuration.GetSection(sectionName));
            return services;
        }

        public static IServiceCollection AddFrameworkRabbitMqMessageBus(this IServiceCollection services, Action<RabbitMqOptions> setupAction, List<Type>? commands = null, Dictionary<string, List<Type>>? events = null)
        {
