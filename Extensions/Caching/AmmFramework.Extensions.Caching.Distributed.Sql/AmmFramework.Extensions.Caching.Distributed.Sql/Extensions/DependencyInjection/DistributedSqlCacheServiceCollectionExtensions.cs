...
using AmmFramework.Extensions.Caching.Distributed.Sql.Options;
using AmmFramework.Extensions.Caching.Distributed.Sql.Services;
using Dapper;
using Microsoft.Data.SqlClient;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;

namespace AmmFramework.Extensions.Caching.Distributed.Sql.Extensions.DependencyInjection;

public static class DistributedSqlCacheServiceCollectionExtensions
{
    public static IServiceCollection AddFrameworkSqlDistributedCache(this IServiceCollection services,
        IConfiguration configuration,
        string sectionName)
        => services.AddFrameworkSqlDistributedCache(configuration.GetSection(sectionName));

    public static IServiceCollection AddFrameworkSqlDistributedCache(this IServiceCollection services, IConfiguration configuration)
    {
