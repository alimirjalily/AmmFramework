...
public static class RegexUtils
{
    ...
    private static readonly Regex MatchOnlyPersianNumbersRange =
    ...
    private static readonly Regex MatchOnlyPersianLetters =
    ...
    public static bool ContainsFarsi(this string txt)
    {
        return !string.IsNullOrEmpty(txt) &&
            MatchArabicHebrew.IsMatch(txt.StripHtmlTags().Replace(",", ""));
    }
    ...
    {
        return !string.IsNullOrEmpty(txt) &&
               MatchOnlyPersianLetters.IsMatch(txt.StripHtmlTags().Replace(",", ""));
    }
    ...
    {
        return !string.IsNullOrEmpty(text) &&
               MatchOnlyPersianNumbersRange.IsMatch(text.StripHtmlTags());
    }
}
